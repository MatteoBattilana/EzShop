...
public class EZShopTest {
    ...
    @Test
    public void testRecordOrderArrivalRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidLocationException, InvalidOrderIdException, InvalidProductIdException, InvalidRFIDException, InvalidTransactionIdException {
        loginAs("ShopManager");
        Integer apple = ezShop.createProductType("apple", "01234567890128", 1.99, null);
        ...
        assertTrue(ezShop.recordOrderArrivalRFID(orderId1, "0000000000"));
        List<Order> allOrders = ezShop.getAllOrders();
        assertEquals(1, allOrders.size());
        ...
        for(int i = 0; i < 10; i++){
            assertTrue(ezShop.addProductToSaleRFID(saleId, "000000000"+i));
        }
        assertFalse(ezShop.addProductToSaleRFID(saleId, "0000000010"));
    }

    @Test
    public void testWrongParametersRecordOrderArrivalRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidLocationException, InvalidOrderIdException, InvalidProductIdException, InvalidRFIDException {
        loginAs("ShopManager");
        Integer apple = ezShop.createProductType("apple", "01234567890128", 1.99, null);
        ezShop.updatePosition(apple, "1-w-2");
        ezShop.recordBalanceUpdate(100);
        ...
        try {
            ezShop.recordOrderArrivalRFID(orderId1, "000000001");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.recordOrderArrivalRFID(orderId1, "-000000001");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.recordOrderArrivalRFID(orderId1, "");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.recordOrderArrivalRFID(orderId1, null);
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.recordOrderArrivalRFID(null, "0000000001");
            fail();
        } catch (InvalidOrderIdException ignored) {} catch (Exception ignored) {fail();}
    }
    ...
    @Test
    public void testAddProductToSaleRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidTransactionIdException, InvalidProductIdException, InvalidLocationException, InvalidRFIDException {
        loginAs("ShopManager");
        Integer productType = ezShop.createProductType("apple", "01234567890128", 1.99, "note");
        ezShop.updatePosition(productType, "1-3-2");
        ezShop.updateQuantity(productType, 5);

        Integer saleId = ezShop.startSaleTransaction();
        assertTrue(ezShop.addProductToSaleRFID(saleId, "0000000001"));
        assertTrue(ezShop.addProductToSaleRFID(saleId, "0000000002"));
        assertEquals(5 - 2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertTrue(ezShop.addProductToSaleRFID(saleId, "0000000003"));
        assertTrue(ezShop.addProductToSaleRFID(saleId, "0000000004"));
        assertFalse(ezShop.addProductToSaleRFID(saleId, "0000000004"));
        assertEquals(5 - 2 - 2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());

        assertFalse(ezShop.addProductToSaleRFID(10, "0000000004"));
        assertFalse(ezShop.addProductToSaleRFID(saleId, "0000000005"));
        assertFalse(ezShop.addProductToSale(saleId, "01234567890128", 11));
    }

    @Test
    public void testWrongParametersAddProductToSaleRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidTransactionIdException, InvalidProductIdException, InvalidLocationException, InvalidRFIDException {
        loginAs("ShopManager");
        Integer productType = ezShop.createProductType("apple", "01234567890128", 1.99, "note");
        ezShop.updatePosition(productType, "1-3-2");
        ezShop.updateQuantity(productType, 5);
        ...
        Integer saleId = ezShop.startSaleTransaction();
        try {
            ezShop.addProductToSaleRFID(-1, "0000000001");
            fail();
        } catch (InvalidTransactionIdException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(null, "0000000001");
            fail();
        } catch (InvalidTransactionIdException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(saleId, "000000001");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(saleId, "-00001");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(saleId, null);
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(saleId, "");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
    }
    ...
    @Test
    public void testWrongParametersDeleteProductToSaleRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidTransactionIdException, InvalidProductIdException, InvalidLocationException, InvalidPaymentException, InvalidRFIDException {
        loginAs("ShopManager");
        Integer productType = ezShop.createProductType("apple", "01234567890128", 1.99, "note");
        ezShop.updatePosition(productType, "1-3-2");
        ezShop.updateQuantity(productType, 10);
        ...
        try {
            ezShop.addProductToSaleRFID(-1, "0000000000");
            fail();
        } catch (InvalidTransactionIdException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(null, "0000000000");
            fail();
        } catch (InvalidTransactionIdException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(saleId, "000000000");
            fail();
        } catch (InvalidRFIDException ignored) {} catch (Exception ignored) {fail();}
        try {
            ezShop.addProductToSaleRFID(saleId, "");
    ...
    @Test
    public void testDeleteProductToSaleRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidTransactionIdException, InvalidProductIdException, InvalidLocationException, InvalidPaymentException, InvalidRFIDException {
        loginAs("ShopManager");
        Integer productType = ezShop.createProductType("apple", "01234567890128", 1.99, "note");
        ezShop.updatePosition(productType, "1-3-2");
        ezShop.updateQuantity(productType, 10);
        ...
        assertEquals(10 - 4, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertTrue(ezShop.deleteProductFromSaleRFID(saleId, "0000000000"));
        assertEquals(10 - 4 + 1, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertTrue(ezShop.deleteProductFromSaleRFID(saleId, "0000000001"));
        assertTrue(ezShop.deleteProductFromSaleRFID(saleId, "0000000002"));
        assertTrue(ezShop.deleteProductFromSaleRFID(saleId, "0000000003"));
        assertEquals(10 - 4 + 1 + 3, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());


        assertFalse(ezShop.deleteProductFromSaleRFID(saleId, "0000000103"));
        assertFalse(ezShop.deleteProductFromSaleRFID(100, "0000000103"));

        // Not allow delete products
        ezShop.endSaleTransaction(saleId);
        assertFalse(ezShop.deleteProductFromSaleRFID(saleId, "0000000004"));
        ezShop.receiveCashPayment(saleId, 100);
        assertFalse(ezShop.deleteProductFromSaleRFID(saleId, "0000000004"));
    }
    ...
    public void testReturnTransactionDeleteBeforePay() throws InvalidPasswordException, InvalidRoleException, InvalidUsernameException, UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidLocationException, InvalidProductIdException, InvalidQuantityException, InvalidTransactionIdException, InvalidPaymentException {
        ...
        assertTrue(ezShop.endReturnTransaction(returnId, true));
        assertEquals(10-5+2, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());
        assertEquals(10-2+2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        SaleTransaction saleTransaction = ezShop.getSaleTransaction(saleId);
        for(TicketEntry t : saleTransaction.getEntries()) {
            if(t.getBarCode().equals("1234567890128")) assertEquals(5-2, t.getAmount());
    ...
    @Test
    public void testReturnProductRFID() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidLocationException, InvalidProductIdException, InvalidQuantityException, InvalidTransactionIdException, InvalidPaymentException, InvalidDiscountRateException, InvalidCreditCardException, InvalidRFIDException {
        loginAs("Administrator");

        Integer apple = ezShop.createProductType("apple", "1234567890128", 1, "empty");
        ezShop.updatePosition(apple, "1-1-2");
        ezShop.updateQuantity(apple, 1);

        Integer saleId = ezShop.startSaleTransaction();
        ezShop.addProductToSale(saleId, "1234567890128", 1);
        ezShop.endSaleTransaction(saleId);
        ezShop.receiveCashPayment(saleId, 100);
        double initialBalance = ezShop.computeBalance();
        Integer returnId = ezShop.startReturnTransaction(saleId);
        ...
        assertEquals(1, ezShop.returnCreditCardPayment(returnId, "4716258050958645"), 0.1);
        assertEquals(initialBalance - 1, ezShop.computeBalance(), 0.1);
        assertEquals(-1, ezShop.returnCreditCardPayment(returnId, "4716258050958645"), 0.1);
        assertEquals(-1, ezShop.returnCreditCardPayment(100, "4716258050958645"), 0.1);
        assertEquals(-1, ezShop.returnCreditCardPayment(100, "4507039484760770"), 0.1);

        for (BalanceOperation t : ezShop.getCreditsAndDebits(null, null)){
            if(t.getType().equals("RETURN")) assertEquals(-1, t.getMoney(), 0.1);
        }
    }
    ...
    @Test
    public void deleteTransactionRFIDTest() throws UnauthorizedException, InvalidProductDescriptionException, InvalidPricePerUnitException, InvalidProductCodeException, InvalidQuantityException, InvalidLocationException, InvalidOrderIdException, InvalidRFIDException, InvalidProductIdException, InvalidTransactionIdException, InvalidPaymentException {
        loginAs("Administrator");

        // BALANCE UPDATE
        assertTrue(ezShop.recordBalanceUpdate(100));
        Integer apple = ezShop.createProductType("apple", "01234567890128", 1.99, "");
        ezShop.updatePosition(apple, "1-2-1");
        Integer cherry = ezShop.createProductType("cherry", "1234567890128", 2.99, "");
        ezShop.updatePosition(cherry, "1-3-1");

        Integer appleOrder = ezShop.issueOrder("01234567890128", 10, 0.99);
        Integer cherryOrder = ezShop.payOrderFor("1234567890128", 20, 0.99);
        ezShop.recordOrderArrival(cherryOrder);
        assertFalse(ezShop.recordOrderArrivalRFID(appleOrder, "0000000001"));
        assertFalse(ezShop.recordOrderArrivalRFID(appleOrder, "0000000020"));
        ezShop.payOrder(appleOrder);
        try{
            ezShop.recordOrderArrivalRFID(appleOrder, "0000000001");
        } catch (InvalidRFIDException ignored) {} catch (Exception ignore) {fail();}
        assertTrue(ezShop.recordOrderArrivalRFID(appleOrder, "0000000020"));
        assertEquals(10, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());

        Integer saleT = ezShop.startSaleTransaction();
        assertTrue(ezShop.addProductToSaleRFID(saleT, "0000000020"));
        assertTrue(ezShop.addProductToSaleRFID(saleT, "0000000001"));
        assertTrue(ezShop.addProductToSale(saleT, "1234567890128", 2));
        assertFalse(ezShop.addProductToSaleRFID(saleT, "0000000001"));
        assertTrue(ezShop.addProductToSaleRFID(saleT, "0000000002"));
        assertTrue(ezShop.addProductToSale(saleT, "01234567890128", 2));

        assertEquals(10 - 1 - 2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20 - 1 - 2 - 1, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());

        assertTrue(ezShop.deleteSaleTransaction(saleT));
        assertEquals(10, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());

        saleT = ezShop.startSaleTransaction();
        assertTrue(ezShop.addProductToSaleRFID(saleT, "0000000020"));
        assertTrue(ezShop.addProductToSaleRFID(saleT, "0000000001"));
        assertTrue(ezShop.addProductToSale(saleT, "1234567890128", 2));
        assertFalse(ezShop.addProductToSaleRFID(saleT, "0000000001"));
        ...
        assertEquals(10 - 1 - 2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20 - 1 - 2 - 1, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());
        assertTrue(ezShop.endSaleTransaction(saleT));
        assertNotEquals(-1, ezShop.receiveCashPayment(saleT, 100));

        // Return transaction
        Integer returnTransaction = ezShop.startReturnTransaction(saleT);
        assertNotEquals(-1, returnTransaction.intValue());
        assertFalse(ezShop.returnProductRFID(returnTransaction, "0000000040"));
        assertTrue(ezShop.returnProductRFID(returnTransaction, "0000000020"));
        assertFalse(ezShop.returnProduct(returnTransaction, "01234567890128", 3));
        assertTrue(ezShop.returnProduct(returnTransaction, "01234567890128", 2));

        assertEquals(10 - 1 - 2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20 - 1 - 2 - 1, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());

        ezShop.endReturnTransaction(returnTransaction, false);
        assertEquals(10 - 1 - 2, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20 - 1 - 2 - 1, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());


        // Return transaction 2
        returnTransaction = ezShop.startReturnTransaction(saleT);
        assertNotEquals(-1, returnTransaction.intValue());
        assertFalse(ezShop.returnProductRFID(returnTransaction, "0000000040"));
        assertTrue(ezShop.returnProductRFID(returnTransaction, "0000000020"));
        assertFalse(ezShop.returnProduct(returnTransaction, "01234567890128", 3));
        ...
        ezShop.endReturnTransaction(returnTransaction, true);
        assertEquals(10 - 1 - 2 + 3, ezShop.getProductTypeByBarCode("01234567890128").getQuantity().intValue());
        assertEquals(20 - 1 - 2 - 1, ezShop.getProductTypeByBarCode("1234567890128").getQuantity().intValue());
    }
}
