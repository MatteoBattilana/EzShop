...
public class TransactionProductTest {
    ...
    public void testProductType() {
        ...
        stringProductHashMap.put("0000000001", new Product("0000000001"));

        TransactionProduct trProduct = new TransactionProduct( product, 0.50, 3, 1.20, stringProductHashMap);
    ...
    public void testGetProducts() {
        ...
        HashMap<String, Product> stringProductHashMap = new HashMap<>();
        stringProductHashMap.put("0000000001", new Product("0000000001"));
        stringProductHashMap.put("0000000002", new Product("0000000002"));
        TransactionProduct trProduct = new TransactionProduct( product, 0.50, 3, 1.20, stringProductHashMap);
        assertEquals(2, trProduct.getProducts().size());
        for(Product p: trProduct.getProducts()){
            if(!p.getRFID().equals("0000000001") && !p.getRFID().equals("0000000002"))
                fail();
        }
    }
